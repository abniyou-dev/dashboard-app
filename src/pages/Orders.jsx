...
function orders() {
  ...
  function handleChange(e) {
    setFilteresData(
      ordersData.filter((or) => or.customer.includes(e.target.value))
    );
  }
  ...
  return (
    <div className="w-full min-h-screen bg-neutral-900 text-white flex">
      ...
      <div className="p-5 space-y-5 w-full overflow-x-hidden">
        <div className="grid">
        ...
        <div className="relative w-full">
          <div className="overflow-x-auto">
            <div className="min-w-155 border border-neutral-700">
              <div
              ...
              {(filtredData.length > 0 ? filtredData : ordersData).map((or) => (
                <div
                  key={or.id}
